...
function LoginPage() {
  ...
  const handleResize = () => {
      ...
      if(screenWidth < 688) {
        setBackground('../assets/fondo-gris-estrellas-movil.svg');
      } else {
        setBackground('../assets/fondo-gris-estrellas.svg');
      }
    };
  ...
  return (
    <div className='login'>
      <div className="background-stars" style={{backgroundImage: `url(${backgroundstars})`}}></div>
