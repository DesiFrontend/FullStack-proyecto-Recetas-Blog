...
import backgoundcalderos from '../assets/fondo-calderos.png';
...
function RegisterPage() {
    ...
    const handleResize = () => {
        ...
        if (screenWidth < 688) {
            setBackground('../assets/fondo-calderos-movil.png');
        } else {
            setBackground('../assets/fondo-calderos.png');
        }
    };
    useEffect(() => {
        ...
        axios
            ...
            .then((res) => {
                if (res.data.status == '1') {
                    ...
                    ); // si todo se verifica correctamente, el usuario es redirigido al login
                    setTimeout(() => {
                        setMessage('');
                        navigate('/login');
                    }, 2000);
    ...
    return (
        <>
            <div className="register">
                <div
                    className="bck-cauldrons"
                    style={{ backgroundImage: `url(${backgoundcalderos})` }}
                ></div>
