...
import smoke from '../assets/recetas_pantalla_principal_proyecto.svg';
import cualdron from '../assets/cauldron-purple.svg';
        ...
        <div className="not-logged">
            ...
            <div className="content1">
                <p>
                    ...
                    <img className='cauldron' src={cualdron} alt="caldero mágico" />
            </div>
            </div>
